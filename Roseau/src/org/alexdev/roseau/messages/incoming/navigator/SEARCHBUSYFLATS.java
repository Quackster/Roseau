...
import org.alexdev.roseau.messages.outgoing.navigator.BUSY_FLAT_RESULTS;
...
public class SEARCHBUSYFLATS implements MessageEvent {
	...
	public void handle(Player player, ClientMessage reader) {
		player.send(new BUSY_FLAT_RESULTS(Roseau.getGame().getRoomManager().getPopularRooms()));
	}
